...
namespace ZeroSDK.UIBuilder.Core.UIElements
{
    ...
    public class kiujyhtgrfedw : MonoBehaviour
    {
        ...
        public void erhreherh(bool wreegtrhfng = false, bool rwregtfhn = true, bool erwfregtrgnh = true)
        {
            if (rwregtfhn)
                hytgrfedw?.Invoke();
        ...
        public void ewegwegwegewg(bool startCallback = true, bool endCallback = true)
        {
            if (startCallback)
        ...
        protected virtual void jrjrtrtnrbererv()
        {
        }
